...
default_pw = "default" #make password default
...
def student_login():
    ...
    while bogus:
        ...
        if (len(student_result) == 0) or (username == bogus):
...
def instructor_login():
    ...
    while bogus:
        ...
        if (len(inst_result) == 0) or (username == bogus):
            print('Username does not exist')
...
def admin_login():
    ...
    while bogus:
        ...
        if (len(adm_result) == 0) or (username == bogus):
            print('Username does not exist')
